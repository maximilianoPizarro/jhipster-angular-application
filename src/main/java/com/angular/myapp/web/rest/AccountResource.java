...
import com.angular.myapp.domain.User;
import com.angular.myapp.service.InvalidPasswordException;
import com.angular.myapp.service.MailService;
import com.angular.myapp.service.UserService;
import com.angular.myapp.service.UsernameAlreadyUsedException;
import com.angular.myapp.service.dto.PasswordChangeDTO;
import com.angular.myapp.service.dto.UserDTO;
import com.angular.myapp.web.rest.errors.EmailAlreadyUsedException;
import com.angular.myapp.web.rest.errors.InvalidPasswordWebException;
import com.angular.myapp.web.rest.errors.LoginAlreadyUsedException;
import com.angular.myapp.web.rest.vm.KeyAndPasswordVM;
import com.angular.myapp.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.angular.myapp.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
