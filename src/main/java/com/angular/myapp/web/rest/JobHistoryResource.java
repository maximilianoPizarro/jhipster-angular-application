...
import com.angular.myapp.domain.JobHistory;
import com.angular.myapp.service.JobHistoryService;
import com.angular.myapp.service.Paged;
import com.angular.myapp.web.rest.errors.BadRequestAlertException;
import com.angular.myapp.web.rest.vm.PageRequestVM;
import com.angular.myapp.web.rest.vm.SortRequestVM;
import com.angular.myapp.web.util.HeaderUtil;
import com.angular.myapp.web.util.PaginationUtil;
import com.angular.myapp.web.util.ResponseUtil;
...
/**
 * REST controller for managing {@link com.angular.myapp.domain.JobHistory}.
 */
